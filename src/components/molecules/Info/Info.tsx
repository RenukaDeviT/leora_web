...
import { demi, normal, small, heavy } from 'ui/styles/font';
import { flexCenter } from 'ui/styles/mixins';
...
export const RoomCreatorInfo = ({ room }: { room: StatefulRoom }) => (
    <RoomCreatorWrapper>
      <label htmlFor='Created By'>Created by
      <input type='text' id='Created By' />
      </label>
      <div>
        <img src={room.createdBy} alt='room'/>
      </div>
    </RoomCreatorWrapper>
  )
